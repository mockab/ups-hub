...
HUB_URL      = 'http://192.168.1.100:8000/api/report'  # hub IP:port
AGENT_ID     = 'closet-apc'          # unique slug, no spaces
AGENT_LABEL  = 'Closet APC 850'      # human-readable name shown in dashboard
AGENT_LOC    = 'Server Closet'       # physical location (optional)
UPS_NAME     = 'apcups'              # name in /etc/nut/ups.conf
UPS_HOST     = 'localhost'           # 'localhost' for local NUT, or IP for remote
